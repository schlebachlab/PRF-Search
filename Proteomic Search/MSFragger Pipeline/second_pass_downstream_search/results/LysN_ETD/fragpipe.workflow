...
database.db-path=/depot/bsdrown/data/Projects/Frameshifting/database/2026-07-17-decoys-contam-v1211_multiSS_downstream_tmd_fs_pep_all_full_length_chimeras_no_all_zero_frame.fa.fas
...
diann.quantification-strategy-2=0
...
fragpipe-config.bin-diann=/fragpipe_bin/fragPipe-23.1/fragpipe-23.1/tools/diann/1.8.2_beta_8/linux/diann-1.8.1.8
fragpipe-config.bin-python=python3
fragpipe-config.tools-folder=/fragpipe_bin/fragPipe-23.1/fragpipe-23.1/tools
freequant.mz-tol=10
...
msbooster.spectra-model=Prosit_2025_intensity_MultiFrag
...
msfragger.fragment_mass_tolerance=400
...
msfragger.misc.fragger.enzyme-dropdown-1=lysn
...
msfragger.search_enzyme_name_1=lysn
...
workdir=/scratch/negishi/afarzam/MSV000086944_results_and_control_searches/second_pass_downstream_nozf/LysN_ETD/LysN_ETD_2pass_results
