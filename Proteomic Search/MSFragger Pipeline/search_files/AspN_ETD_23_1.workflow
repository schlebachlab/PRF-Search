# Workflow: AspN_ETD_23_1


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/depot/bsdrown/data/Projects/Frameshifting/database/2025-05-23-decoys-contam-UP000005640_isoforms.fasta.fas
...
workflow.description=Description not present
